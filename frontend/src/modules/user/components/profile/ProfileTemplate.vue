<template>
  <!-- Usando o componente LoadingErrorState -->
  <LoadingErrorState :isLoading="isLoadingFetch" :isError="isError" />

  <!-- Formulário de perfil quando os dados são carregados com sucesso -->
  <div v-if="!isLoadingFetch && !isError" data-testid="profile-page" class="profile-page">
    ...
    <div data-testid="profile-container-form" class="profile-container">
      <div class="form-group">
        ...
        <input data-testid="input-fullname-profile" id="fullName" type="text" placeholder="Digite seu nome completo" v-model="fullName" />
      </div>
      <div class="form-group">
      ...
      <div class="form-group">
        ...
        <input data-testid="input-phone-profile" id="phone" type="tel" placeholder="(00) 00000-0000" v-model="phone" />
      </div>
      <div class="form-group">
        <label for="cpfCnpj">CPF ou CNPJ</label>
        <input data-testid="input-cpfcnpj-profile" id="cpfCnpj" type="text" placeholder="Digite seu CPF ou CNPJ" v-model="cpfCnpj" disabled />
      </div>
      <button data-testid="btn-save-profile" type="button" class="btn btn-save save-button" :disabled="!hasChanges || isUpdating" @click="handleSave">
...
// Atualiza os campos do formulário e salva os dados originais
watchEffect(() => {
  if (user.value) {
